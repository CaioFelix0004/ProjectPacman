# Codigo do pacman com boas praticas de programação, e completo!
# Feito por: Caio
...
class Cenario(ElementoJogo):
    ...
    def calcular_regras_jogando(self):
        for movivel in self.moviveis:
            ...
            col_intecao = int(movivel.coluna_intencao)
            ...
            if isinstance(movivel, Fantasma) and movivel.linha == self.pacman.linha and movivel.coluna == self.pacman.coluna:
                ...
                if 0 <= col_intecao < 28 and 0 <= lin_intencao < 29 and self.matriz[lin_intencao][col_intecao] != 2:
    ...
    def pintar_linha(self, tela, numero_linha, linha):
        for numero_coluna, coluna in enumerate(linha):
            ...
            if coluna == 1:
                pygame.draw.circle(tela, AMARELO, (x + (self.tamanho // 2), y + (self.tamanho // 2)),
                                   self.tamanho // 10, 0)
    ...
    def pintar_vitoria(self, tela):
        self.pintar_texto_centro(tela, "V I T O R I A", VERDE)
...
class Fantasma(ElementoJogo, Movivel):
    ...
    def recusar_movimento(self, direcoes):
        self.linha_intencao = self.linha
        self.coluna_intencao = self.coluna
        self.direcao = self.mudar_direcao(direcoes)
